    ...
    function handleSendData() {
      subject.next({
        data: [
          ...
          "",
          ""
          // `<p>${prompt}<br>\n${negativePrompt}<br>\nSteps: ${steps}, Sampler: DPM++ 2M Karras, CFG scale: 7,  Seed: ${randomSeed}, Size: ${width}x${height}, Model hash: ${modelHash}, Model: 墨幽二次元_v2, Denoising strength: ${redraw}, Clip skip: 2, ControlNet 0: &quot;Module: none, Model: control_v11f1e_sd15_tile [a371b31b], Weight: 1, Resize Mode: Crop and Resize, Low Vram: False, Guidance Start: 0, Guidance End: 1, Pixel Perfect: True, Control Mode: Balanced&quot;, ControlNet 1: &quot;Module: none, Model: control_v11f1e_sd15_tile [a371b31b], Weight: 1, Resize Mode: Crop and Resize, Low Vram: False, Guidance Start: 0, Guidance End: 1, Pixel Perfect: True, Control Mode: Balanced&quot;, Version: v1.6.0</p>`,
